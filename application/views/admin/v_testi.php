                ...
                <div class="box-body">
                  <table id="example1" class="table table-striped" style="font-size:13px;">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td><img src="<?php echo base_url() . 'user/assets/img/avatars/' . $foto; ?>" style="width:90px;"></td>
                          <td><?php echo $nama; ?></td>

                          <td><?php echo $testi; ?></td>
                          <td style="text-align:right;">
                            <a class="btn" href="<?php echo base_url() . 'admin/testi/get_edit/' . $id_testi; ?>"><span class="fa fa-pencil"></span></a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
