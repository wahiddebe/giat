                ...
                <div class="box-body">
                  <table id="example1" class="table table-striped" style="font-size:13px;">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td><img src="<?php echo base_url() . 'user/assets/img/tech/' . $foto; ?>" style="width:90px;"></td>
                          <td><?php echo $judul_1; ?></td>

                          <td><?php echo $isi_1; ?></td>
                          <td><?php echo $judul_2; ?></td>

                          <td><?php echo $isi_2; ?></td>
                          <td style="text-align:right;">
                            <a class="btn" href="<?php echo base_url() . 'admin/welcome/get_edit/' . $id_welcome; ?>"><span class="fa fa-pencil"></span></a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
